#!/bin/bash
# from https://raw.githubusercontent.com/creationix/nvm/8aebf863294ef3a21e2790c01af16405213381de/install.sh
...
nvm_check_global_modules() {
  ...
  # commented out by Tarek
  # not sure what's up with this wonky string but bash doesn't like it
...
nvm_do_install() {
  ...
  # commented out by Tarek
  # let's not mess with the ec2-profile
  # instead, we manually load nvm on install (in the spec) and on start (in the config script)
